...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "material_cache_enabled": "Material analysis cache: .vocalprocess_material_cache.json is reused when the folder is unchanged.",
    ...
    "zh": {
        ...
        "material_cache_enabled": "素材分析缓存：素材集未变化时复用 .vocalprocess_material_cache.json。",
