...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "lyrics_format_hint": ".txt, .doc, .docx, .lrc, .srt",
        ...
        "assembly_mode_active": "Assembly mode: material clips will be concatenated and time-stretched to the original audio duration.",
        "model_assisted_ordering_active": "Model-assisted ordering: vocals will be analyzed before material assembly.",
    ...
    "zh": {
        ...
        "assembly_mode_active": "拼接模式：素材音频将按顺序拼接，并整体拉伸/压缩到原音频时长。",
        "model_assisted_ordering_active": "模型辅助排序：拼接前会先分析原音频和素材人声。",
